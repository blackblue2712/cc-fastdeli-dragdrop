...
export class TheMessageStore {
  ...
  @observable showingMessage: boolean = false;
  ...
  @action.bound showMessage = flow(function* (this: TheMessageStore, data: {
    ...
    let atttemp = 0;
    while (this.showingMessage === true && atttemp < 50) {
      yield wait(100);
      atttemp++;
    }
